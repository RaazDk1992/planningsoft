# Generated by Django 4.0.5 on 2022-07-23 14:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prj_start_date_en', models.DateField(default=datetime.datetime(2022, 7, 23, 14, 40, 56, 943742, tzinfo=utc))),
                ('prj_completion_date', models.CharField(max_length=80)),
                ('prj_completion_date_en', models.DateField(default=datetime.datetime(2022, 7, 23, 14, 40, 56, 943742, tzinfo=utc))),
                ('is_multiyear', models.BooleanField(default=False)),
                ('amount_of_work', models.CharField(default='०', max_length=5)),
