# Generated by Django 4.0.5 on 2022-07-11 10:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prj_start_date_en', models.DateField(default=datetime.datetime(2022, 7, 11, 10, 0, 25, 439415, tzinfo=utc))),
                ('prj_completion_date', models.CharField(max_length=80)),
                ('prj_completion_date_en', models.DateField(default=datetime.datetime(2022, 7, 11, 10, 0, 25, 439415, tzinfo=utc))),
