...
class YojanaDetails(models.Model):
    ...
    amt_from_palika_en = models.CharField(max_length=10)
    amt_from_comittee = models.FloatField(default=0.0)
    amt_from_comittee_en = models.CharField(max_length=10)
    amt_from_gai_sasa = models.FloatField(default=0.0)
    amt_from_gai_sasa_en = models.CharField(max_length=10)
    ...
    affected_household_en = models.CharField(max_length=5)
